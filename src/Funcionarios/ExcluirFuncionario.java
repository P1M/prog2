...
public class ExcluirFuncionario extends javax.swing.JFrame {
     ...
     */
    public ExcluirFuncionario() throws SQLException, ClassNotFoundException {
        initComponents();
        Operacao();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cpf = model.getValueAt(selectedRowIndex, 6).toString();
        System.out.println(cpf);
        int SelectedRowIndex = jTable2.getSelectedRow();
        model.removeRow(SelectedRowIndex);
        try {
            DAOFuncionarios daofuncionarios = new DAOFuncionarios();
            daofuncionarios.deletarFuncionario(Integer.parseInt(cpf));
